...
%causados pela alteração de um estado de operação de um aparelho. A
%representação obtida através do mesmo foi um degrade na escala de
%energia. Sua representação permitiu observar a existência de duas
%geladeiras distintas nos conjuntos de dados no mapa. Eventos
%decorrentes de acionamentos/desacionamentos de ventilação do ar
%condicionado ativaram regiões próximas às marcadas pelos ventiladores.
%Observou-se uma maior confusão na separação de aparelhos de menor
%consumo, como as lâmpadas fluorescentes e televisores.
%Estudou-se, também, a possibilidade de empregá-los para atuar como um
%detector de eventos. O mesmo mostrou capacidade de ser empregado para
%realizar tal tarefa, porém é necessário aperfeiçoá-lo.
%Apesar do \acs{som} não ter mostrado a capacidade de
